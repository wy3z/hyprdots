...
-- === Reload / quit ===
hl.bind("SUPER + CTRL + SHIFT + R", hl.dsp.exec_cmd("hyprctl reload")) -- SHIFT+R is a column width toggle
...
-- act.col_toggle flips the focused column between two widths (fractions of the
-- monitor's tape axis) and no-ops off the scrolling layout -- colresize errors
-- on master/dwindle. See scripts.lua.
hl.bind("SUPER + R", function()
	act.col_toggle(0.5, 1.0)
end) -- column width: 50% <-> 100%
hl.bind("SUPER + SHIFT + R", function()
	act.col_toggle(0.333, 0.75)
end) -- column width: 33% <-> 75%
